          ...
          <form onSubmit={handleSaveStory} className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-100 transform transition-all duration-300 hover:scale-[1.02]">
              ...
              <ol className="space-y-3 text-blue-700">
                ...
                <li className="flex items-center space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-medium">6</span>
                  <span>Generate images and audio for your scenes (requires credits)</span>
                </li>
              </ol>
            </div>
